...
<DL class="search clearfix">
  ...
  <UL>
    ...
    value=500-1000000>500以上</OPTION></SELECT> </LI></UL></DD>
  </FORM></DL></DIV>
...
<DIV class=houseinfo>
  <P>图片：<SPAN><img src="http://localhost:81/${house.path}" width="100px" height="100px"> </SPAN></P>
...
<H2><SPAN><STRONG>房屋详情</STRONG></SPAN></H2>
<DIV class=content>
